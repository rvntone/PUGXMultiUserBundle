...
[![Build Status](https://secure.travis-ci.org/rvntone/PUGXMultiUserBundle.png?branch=master)](http://travis-ci.org/rvntone/PUGXMultiUserBundle)

The branch (2.0) supports FOSUserBundle 2.0 and Symfony >=2.1, <2.4.
[![Build Status](https://secure.travis-ci.org/rvntone/PUGXMultiUserBundle.png?branch=2.0)](http://travis-ci.org/rvntone/PUGXMultiUserBundle)

The branch (1.4) supports FOSUserBundle 1.3 and Symfony 2.1 with new approach
[![Build Status](https://secure.travis-ci.org/rvntone/PUGXMultiUserBundle.png?branch=1.4)](http://travis-ci.org/rvntone/PUGXMultiUserBundle)

For the old implementation see:

The branch (1.3) supports FOSUserBundle 1.3 and Symfony 2.1 
[![Build Status](https://secure.travis-ci.org/rvntone/PUGXMultiUserBundle.png?branch=1.3)](http://travis-ci.org/rvntone/PUGXMultiUserBundle)

The branch (1.2) supports FOSUserBundle 1.2 and Symfony 2.0
[![Build Status](https://secure.travis-ci.org/rvntone/PUGXMultiUserBundle.png?branch=1.2)](http://travis-ci.org/rvntone/PUGXMultiUserBundle)


Documentation
-------------

[Read the Documentation](https://github.com/rvntone/PUGXMultiUserBundle/blob/master/Resources/doc/index.md)
